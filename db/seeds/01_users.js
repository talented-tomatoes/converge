  ...
  return knex('users').del()
    .then(function () {
      ...
      .insert([
        ...
        {login_id: '117995269280335550175', first_name: 'Tomato', last_name: 'Three', avatar_url: 'https://curbstonevalley.com/wp-content/uploads/2010/10/GermanOrange-150x150.jpg', email: 'hrsf78tt03@gmail.com', linkedin_id: 'tomato03', phone_number: '123-456-7890', user_type: 'host' },        {login_id: '106157414943730174639', first_name: 'Tomato', last_name: 'Four', avatar_url: 'https://curbstonevalley.com/wp-content/uploads/2010/10/IlliniStar-150x150.jpg', email: 'hrsf78tt04@gmail.com', linkedin_id: 'tomato04', phone_number: '123-456-7890', user_type: 'host' },
      ]);
    });
};
