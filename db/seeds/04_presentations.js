  ...
  return knex('presentations').del()
    .then(function () {
      ...
      .insert([
        ...
        {name: 'Edutainment', description: 'Remember when you stared at the clock for what seemed like an eternity in Mrs. William s third period Biology class, praying that somehow you could move time and end the most boring lecture possible? If you do — and are convinced that learning CANNOT be entertaining — prepare to be proven wrong! Online video has changed how we learn; find out how from these top-notch EDU creators.', date: '2018-06-22', time: '2:00PM', location: 'Red Room', conference_id: 1}
      ]);
    });
};
