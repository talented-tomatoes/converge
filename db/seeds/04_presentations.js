  ...
  return knex('presentations').del()
    .then(function () {
      ...
      .insert([
        ...
        {name: 'Emerging Business Models: The Changing Face of the MCN', description: 'This session features 1:1 interviews with 4 of the most well-known multi-channel networks, as we explore how their business models have changed to address marketplace changes, the explosion of new platforms, life after acquisition, and more. After the set of 1:1 interviews, we will bring all the execs up for a roundtable discussion on what the future looks like.', date: '09-23-2017', time: '11:00AM', location: '', speaker_id: 5, conference_id: 2},
        {name: 'Edutainment', description: 'Remember when you stared at the clock for what seemed like an eternity in Mrs. William s third period Biology class, praying that somehow you could move time and end the most boring lecture possible? If you do — and are convinced that learning CANNOT be entertaining — prepare to be proven wrong! Online video has changed how we learn; find out how from these top-notch EDU creators.', date: '09-23-2017', time: '2:00PM', location: '', speaker_id: 6, conference_id: 2}
      ]);
    });
};
